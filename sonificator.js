...
(function () {
  ...
  var style_rules = [
    ...
    '.soni-no-bg, a.soni-no-bg { color: #222 !important; background-color: rgba(0,0,0,0.0) !important;}',
    '.soni-has-bg { opacity: 0.2 !important; }',
    ...
    '.soni-glitch.soni-glitch1.soni-no-bg.soni-highlight { transform: translateX(5vw) translateY(5vw);  color: rgba(255,245,255,0.7) !important; background-color: rgba(0,0,0, 0.0) !important; width: 50vw  !important; height: 20vh  !important; font-size: 1.5em !important; z-index: 100000;}',
    '.soni-glitch.soni-glitch2.soni-no-bg.soni-highlight { transform: translateX(-5vw) translateY(5vw);  color: rgba(245,255,255,0.7) !important; background-color: rgba(255,255,255, 0.2) !important; width: 20vw  !important; height: 50vh  !important; font-size: 1.5em !important; z-index: 100000;}',
    ...
    '.soni-glitch.soni-glitch4.soni-no-bg.soni-highlight { transform: translateX(-5vw) translateY(-5vw);  color: rgba(0,0,0,1.0) !important; background-color: rgba(0,0,0,0.0) !important; width: 50vw  !important; height: 80vh  !important; font-size: 1.5em !important; z-index: 100000;}',
...
window.addEventListener('resize', () =>{
  ...
  window.max.bindInlet('getnote', function () {
    ...
    if ( ctx.current.nodeType === 1 ) {
       const elem = ctx.current
      if ( ctx.current.nodeName === 'H1' || ctx.current.nodeName === 'H2' ) {
      ...
      if ( ctx.currentVisibility ) {
        ...
        if ( prevElem ) {
          prevElem.classList.remove('soni-highlight-active')
          if ( Math.random() >- 0.2 ) {
            prevElem.classList.add('soni-highlight-fadeout')
          }
          prevElem = null
        }
        prevElem = elem
