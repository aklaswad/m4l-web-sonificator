...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 110.0, 58.0, 48.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 929.5, 396.0, 32.0, 22.0 ],
					"text" : "ftom"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 874.5, 303.0, 29.5, 22.0 ],
					"text" : "f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 917.0, 367.0, 29.5, 22.0 ],
					"text" : "* 1."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 909.0, 266.5, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 917.0, 297.0, 29.5, 22.0 ],
					"text" : "1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 936.0, 330.0, 29.5, 22.0 ],
					"text" : "/ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 882.0, 330.0, 32.0, 22.0 ],
					"text" : "mtof"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 744.0, 489.0, 108.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 744.0, 530.0, 49.0, 22.0 ],
					"text" : "noteout"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 858.75, 407.0, 29.5, 22.0 ],
					"text" : "i"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1121.0, 472.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1085.0, 436.0, 29.5, 22.0 ],
					"text" : "+ 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1003.5, 410.0, 31.0, 22.0 ],
					"text" : "* -1."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 968.0, 516.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 988.5, 379.0, 29.5, 22.0 ],
					"text" : "* 1."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1209.5, 354.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1092.0, 297.0, 29.5, 22.0 ],
					"text" : "f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 929.5, 239.0, 29.5, 22.0 ],
					"text" : "/ 1."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 986.0, 239.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1092.0, 233.0, 41.0, 48.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 131.0, 7.0, 41.0, 48.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_annotation_name" : "Range",
							"parameter_enum" : [ "0", "1" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 709.5, 297.0, 50.0, 22.0 ],
					"text" : "60"
				}
